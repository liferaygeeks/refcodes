 ...
 * @generated
 */
public class BusinessUserLocalServiceClp implements BusinessUserLocalService {
    ...
    public BusinessUserLocalServiceClp(
    ...
    public com.refcodes.portlets.businesscenter.model.BusinessUser addBusinessUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(businessUser) });
        } catch (Throwable t) {
        ...
        return (com.refcodes.portlets.businesscenter.model.BusinessUser) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.refcodes.portlets.businesscenter.model.BusinessUser createBusinessUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { businessUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.refcodes.portlets.businesscenter.model.BusinessUser deleteBusinessUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { businessUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.refcodes.portlets.businesscenter.model.BusinessUser fetchBusinessUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { businessUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.refcodes.portlets.businesscenter.model.BusinessUser getBusinessUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { businessUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.refcodes.portlets.businesscenter.model.BusinessUser> getBusinessUsers(
        ...
        return (java.util.List<com.refcodes.portlets.businesscenter.model.BusinessUser>) ClpSerializer.translateOutput(returnObj);
    }
