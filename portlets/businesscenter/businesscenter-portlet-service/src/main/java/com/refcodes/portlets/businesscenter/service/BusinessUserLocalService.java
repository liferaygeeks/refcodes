...
/**
 * Provides the local service interface for BusinessUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BusinessUserLocalServiceUtil
...
public interface BusinessUserLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BusinessUserLocalServiceUtil} to access the business user local service. Add custom service methods to {@link com.refcodes.portlets.businesscenter.service.impl.BusinessUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
